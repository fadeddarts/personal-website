    ...
    <Container maxW="4xl" centerContent mt="16">
      ...
      <VStack gap="10" align="center" justify="center" w="100%">
        <HStack gap="20" justify="center" align="start" flexWrap="wrap">
          ...
          <ProjectCard title="Twitter Discord Webhook" description="View on GitHub" link="https://github.com/fadeddarts/Twitter-Discord-Webhook" accordionTitle="Technologies" accordionItems={["Python","Workflows","API"]}></ProjectCard>
        ...
        <HStack gap="20" spacing={4} justify="center" align="start" flexWrap="wrap">
          <ProjectCard title="Blog Tweet Integration" link="/personal-website/#/blog" description="View" accordionTitle="Technologies" accordionItems={["Python","API","GitHub Actions"]}></ProjectCard>
